...
namespace System.Text
{
    public readonly ref partial struct Utf8Span
    {
        ...
        public bool TryFind(char value, StringComparison comparisonType, out Range range)
        {
            ...
            {
                Utf8String.CheckStringComparison(comparisonType);
        ...
        private unsafe bool TryFind(Utf8Span value, StringComparison comparisonType, out Range range, bool fromBeginning)
        {
            ...
            {
                throw new InvalidOperationException("Only StringComparison.Ordinal and StringComparison.OrdinalIgnoreCase are supported by Utf8Span and Utf8String on netstandard.");
            }

            // We're in the OrdinalIgnoreCase scenario. On netstandard this is the only non-ordinal scenario
            // we support because it's the only way for us to make correct assumptions about the matchLength.
            ...
            int idx = thisTranscodedToUtf16.IndexOf(otherTranscodedToUtf16, StringComparison.OrdinalIgnoreCase);
            int matchLength = otherTranscodedToUtf16.Length;
