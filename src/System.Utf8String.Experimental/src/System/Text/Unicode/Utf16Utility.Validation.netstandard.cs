            ...
            if (Vector.IsHardwareAccelerated)
            {
                if (inputLength >= Vector<ushort>.Count)
                {
                    ...
                    do
                    {
                        ...
                        Vector<uint> sumVector = (Vector<uint>)(Vector<ushort>.Zero - twoOrMoreUtf8Bytes - threeOrMoreUtf8Bytes);
                        ...
                        if (surrogateChars != Vector<ushort>.Zero)
                        {
                            ...
                            uint surrogatePairsCountUint = surrogatePairsCount; // zero-extend to native int size

                            // 2 UTF-16 chars become 1 Unicode scalar

                            tempScalarCountAdjustment -= (int)surrogatePairsCountUint;
                            ...
                            tempUtf8CodeUnitCountAdjustment -= surrogatePairsCountUint;
                            tempUtf8CodeUnitCountAdjustment -= surrogatePairsCountUint;
                        }
